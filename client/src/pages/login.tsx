...
export default function AITutorSlidingAuth(): JSX.Element {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative font-[Poppins] bg-gradient-to-br from-indigo-400 to-purple-600 overflow-hidden">
      {/* Animated Particles */}
      ...
      >
        ...
        <div className="form-container sign-up-container">
          <form className="ai-form" onSubmit={handleSignUp}>
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Create AI Profile</h1>
            <input
              className="ai-input"
              type="text"
              name="name"
        ...
        <div className="form-container sign-in-container">
          <form className="ai-form" onSubmit={handleSignIn}>
            ...
            <p className="text-gray-600 mb-6">Continue your AI-powered learning journey</p>
            <input
              className="ai-input"
              type="email"
              name="email"
            ...
            <a
              href="#"
              className="text-sm text-purple-600 hover:text-purple-800 mb-4 block"
            >
        ...
        <div className="overlay-container">
          <div className="overlay">
            <div className="overlay-panel overlay-left">
              <h1 className="text-3xl font-bold mb-4 neon-glow">Welcome Back!</h1>
              ...
              <div className="mb-6">
                <div className="text-sm opacity-80">
                  ...
                  <br />🎯 Adaptive Learning Paths
                  <br />💡 Intelligent Recommendations
                </div>
              </div>
            ...
            <div className="overlay-panel overlay-right">
              <h1 className="text-3xl font-bold mb-4 neon-glow">Start Your Journey!</h1>
              <p className="mb-6 text-lg">
      ...
      {/* Styles moved into component for easy drop-in usage */}
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .overlay { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; position: relative; left: -100%; height: 100%; width: 200%; transform: translateX(0); transition: transform 0.6s ease-in-out; }
        ...
        .ai-input { background: rgba(102,126,234,0.1); border: 2px solid rgba(102,126,234,0.3); border-radius: 12px; padding: 15px 20px; margin: 8px 0; width: 100%; font-size: 14px; transition: all 0.3s ease; color: #333; }
        .ai-input:focus { outline: none; border-color: #667eea; box-shadow: 0 0 0 3px rgba(102,126,234,0.1); transform: translateY(-2px); }
        .ai-button { border-radius: 20px; border: none; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; font-size: 14px; font-weight: 600; padding: 15px 45px; letter-spacing: 1px; text-transform: uppercase; transition: all 0.3s ease; cursor: pointer; position: relative; overflow: hidden; }
        .ai-button:hover { transform: translateY(-2px); box-shadow: 0 10px 25px rgba(102,126,234,0.3); }
        ...
        .ai-avatar { width: 80px; height: 80px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2rem; margin-bottom: 20px; animation: pulse 2s infinite; box-shadow: 0 10px 30px rgba(102,126,234,0.3); }
        @keyframes pulse { 0%{ transform: scale(1); box-shadow: 0 10px 30px rgba(102,126,234,0.3);} 50%{ transform: scale(1.05); box-shadow: 0 15px 40px rgba(102,126,234,0.5);} 100%{ transform: scale(1); box-shadow: 0 10px 30px rgba(102,126,234,0.3);} }
        ...
        .ai-message { background: linear-gradient(135deg, rgba(102,126,234,0.1) 0%, rgba(118,75,162,0.1) 100%); border: 1px solid rgba(102,126,234,0.2); border-radius: 15px; padding: 15px; margin: 15px 0; animation: slideIn 0.5s ease-out; }
